...
>
      ...
      <div className="floating right">
        ...
        src="/outside.jpg"
         alt=""
         className="flower-decoration flower1"
        />

        <img
          src="/outside2.jpg"
          alt=""
          className="flower-decoration flower2"
        />

        <img
          src="/outside3.jpg"
         alt=""
         className="flower-decoration flower3"
        />
      ...
      <section className="about">
        ...
        <p>
          i do art, code, sports,
          ride motorcycles, bicycles,
          play games and bake foods.
        </p>
  ...
  <div className="footer-right">
    <a
      href="https://www.tiktok.com/@foruvi"
      target="_blank"
